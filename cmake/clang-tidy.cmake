option(TILES_TIDY "Run clang-tidy with the compiler." OFF)
if(TILES_TIDY)
  ...
  if(TILES_CLANG_TIDY_COMMAND)
    set(CLANG_TIDY_COMMAND "${TILES_CLANG_TIDY_COMMAND}")
  else()
    find_program(CLANG_TIDY_COMMAND NAMES clang-tidy clang-tidy-16)
  endif()
